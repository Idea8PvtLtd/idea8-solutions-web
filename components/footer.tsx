              ...
              <ul className="space-y-2">
                {links.map((link) => (
                  <li key={link}>
                    <a
                      href="#"
                      className="text-white hover:text-slate-300 transition-colors duration-200 text-sm"
                    >
                      {link}
                    </a>
                  </li>
        ...
        >
          <div className="flex items-center space-x-2 mb-4 md:mb-0">
            <span className="text-lg font-bold font-mono">
              speck<span className="text-slate-400">design</span>
            </span>
          </div>
          <p className="text-slate-400 text-sm">
            © 2024 Speck Design. All Rights Reserved.
          </p>
        </motion.div>
      </div>
    </footer>
