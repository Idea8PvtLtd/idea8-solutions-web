...
export function HeroSection() {
  return (
    <section className="wrapper">
      <div className="relative min-h-screen flex items-end overflow-hidden rounded-2xl">
        {/* Background Image */}
        ...
        <div className="relative z-10  text-white p-8 pb-20 lg:p-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
            <motion.div
              ...
              className="space-y-6"
            >
              <h1 className="text-7xl lg:text-[138.24px] font-semibold leading-none tracking-tighter text-balance">
                NPI &<br />
                Product
              </h1>
            </motion.div>
