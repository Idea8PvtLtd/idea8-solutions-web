        ...
        <div className="flex items-center justify-between h-16">
          ...
          <motion.div whileHover={{ scale: 1.05 }} className="flex-shrink-0">
            <span className="text-xl font-bold text-foreground font-mono">
              speck<span className="text-muted-foreground">design</span>
            </span>
          </motion.div>
            ...
            <div className="ml-10 flex items-baseline space-x-8">
              {navItems.map((item) => (
                <motion.a
                  ...
                  className="text-muted-foreground hover:text-foreground transition-colors duration-200 text-sm font-medium relative"
                >
                  {item.name}
                </motion.a>
              ))}
